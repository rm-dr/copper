...
pub(super) async fn del_dataset<Client: DatabaseClient, StorageClient: StorageDatabaseClient>(
	jar: CookieJar,
	...
	let res = state.storage_db_client.del_dataset(dataset_id.into()).await;
